...
# user data
ssid = "JioFi3" # wifi router name
pw = "Sofi@31193" # wifi router password
url = "http://worldtimeapi.org/api/timezone/Asia/mumbai" # see http://worldtimeapi.org/timezones
...
def clock():
    ...
    oled = SSD1306_I2C(128, 64, I2C(scl=Pin(4), sda=Pin(5)))
    oled.fill(0)
